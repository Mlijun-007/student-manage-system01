...
public class EnrollmentController {
    ...
    public ResponseEntity<Page<Enrollment>> getEnrollmentsByStudentId(@PathVariable Long studentId, Pageable pageable) {
    ...
    public ResponseEntity<Page<Enrollment>> getEnrollmentsByCourseId(@PathVariable Long courseId, Pageable pageable) {
